...
enum {
    ...
    HBOS_SYS_GUI_RECT,
    HBOS_SYS_GUI_TEXT,
    HBOS_SYS_GUI_PRESENT,
    HBOS_SYS_GUI_POLLKEY,
    HBOS_SYS_GUI_POLLMOUSE,
    HBOS_SYS_WIN_OPEN,
    HBOS_SYS_WIN_INFO,
    HBOS_SYS_WIN_CLEAR,
    HBOS_SYS_WIN_FILL,
    ...
    HBOS_SYS_PIPE2,
    HBOS_SYS_EVENTFD2,
    HBOS_SYS_EPOLL_CREATE1,
    HBOS_SYS_EPOLL_CTL,
    HBOS_SYS_EPOLL_WAIT,
    HBOS_SYS_SCHED_YIELD,
    HBOS_SYS_GETRANDOM,
    HBOS_SYS_FUTEX,
    HBOS_SYS_ARCH_PRCTL,
    HBOS_SYS_CLONE_THREAD,
    HBOS_SYS_SET_TID_ADDRESS,
    HBOS_SYS_SOCKETPAIR,
    HBOS_SYS_GETSOCKOPT,
    HBOS_SYS_SETSOCKOPT,
    HBOS_SYS_SHUTDOWN,
    HBOS_SYS_MEMFD_CREATE,
    HBOS_SYS_SENDMSG,
    HBOS_SYS_RECVMSG,
